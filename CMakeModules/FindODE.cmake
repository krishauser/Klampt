...
# ODE has already been found and the necessary variables are cached
  ...
  set(ODE_FOUND FALSE)
  if (ODE_INCLUDE_DIRS AND ODE_LIBRARIES)
    message("found ODE in" ${ODE_ROOT})
    set(ODE_FOUND TRUE)
  else (ODE_INCLUDE_DIRS AND ODE_LIBRARIES)
    message("did not find  ODE in" ${ODE_ROOT})
  ...
  if (ODE_FOUND)
    ...
    if (ODE_DEFINITIONS_FOUND)
      if (ODE_DEFINITIONS MATCHES -DdDOUBLE)
        ...
        if (ODE_DEFINITIONS MATCHES -DdSINGLE)
          message(STATUS "ODE uses single precision")
        else (ODE_DEFINITIONS MATCHES -DdSINGLE)
          message(STATUS "Could not determine precision level of ODE floats")
        endif (ODE_DEFINITIONS MATCHES -DdSINGLE)
