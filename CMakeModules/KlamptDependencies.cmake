...
IF(WIN32)
  #Assume binaries for KrisLibrary, ODE, GLPK, GLUI, GLEW, tinyxml are in the library
  ...
  SET(KLAMPT_DEFINITIONS -DHAVE_GLUI=1 -DHAVE_GLUT=1 -DHAVE_TIXML=1 -DTIXML_USE_STL -DdDOUBLE -DNOMINMAX -DGLUI_NO_LIB_PRAGMA -DUSE_BOOST_THREADS=1 -DHAVE_BOOST=1 -DHAVE_GLEW)
  ...
  SET(KLAMPT_INCLUDE_DIRS ${KLAMPT_INCLUDE_DIRS} ${GLEW_INCLUDE_DIR})
...
ELSE(WIN32)
  ...
  IF(ODE_FOUND)
    ...
    SET(KLAMPT_LIBRARIES ${KLAMPT_LIBRARIES} -pthread)
  ENDIF(ODE_FOUND)
