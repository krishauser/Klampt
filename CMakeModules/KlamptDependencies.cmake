...
IF(WIN32)
  ...
  SET(KLAMPT_LIBRARIES ${KLAMPT_LIBRARIES} debug ${ODE_LIBRARY_DEBUG} optimized ${ODE_LIBRARY_RELEASE} opengl32 Ws2_32 winmm Gdiplus )
  SET(KLAMPT_INCLUDE_DIRS  ${KLAMPT_INCLUDE_DIRS} ${ODE_INCLUDE_DIR} )
