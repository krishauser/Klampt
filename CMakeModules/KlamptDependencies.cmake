...
IF(WIN32)
  ...
  FIND_PATH(KRISLIBRARY_INCLUDE_DIR myfile.h
    PATHS ${KRISLIBRARY_ROOT}/KrisLibrary  )
  ...
  SET(KLAMPT_LIBRARIES debug ${KRISLIBRARY_LIBRARY_DEBUG} optimized ${KRISLIBRARY_LIBRARY_RELEASE} debug ${ODE_LIBRARY_DEBUG} optimized ${ODE_LIBRARY_DEBUG} ${GLPK_LIBRARY} debug ${GLUI_LIBRARY_DEBUG} optimized ${GLUI_LIBRARY_RELEASE} debug ${TINYXML_LIBRARY_DEBUG} optimized ${TINYXML_LIBRARY_RELEASE} glut32 opengl32 Ws2_32 winmm)
