 ...
 * 
 *   if(changed) {
 *     LOG4CXX_INFO(KrisLibrary::logger(),"Path was successfully updated, split time "<<splitTime<<", plan time "<<planTime);
 *   }
 *   else {
 *     LOG4CXX_INFO(KrisLibrary::logger(),"Path update was unsuccessful, split time "<<splitTime<<", plan time "<<planTime);
 *   }
 * }
 * @endcode
 */
 ...
 *     LOG4CXX_INFO(KrisLibrary::logger(),"Planner had an update\n")
 *   }
