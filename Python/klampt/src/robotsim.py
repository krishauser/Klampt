...
class Appearance(object):
    ...
    def setTexture2D(self, w, h, format, bytes, topdown=True):
        r"""
        setTexture2D(Appearance self, int w, int h, char const * format, std::vector< unsigned char,std::allocator< unsigned char > > const & bytes, bool topdown=True)
...
class RobotModelLink(object):
    ...
    *   The various Jacobians of points on the link, accessed by
    ...
    def getJacobian2(self, plocal, links):
        r"""
        getJacobian2(RobotModelLink self, double const [3] plocal, intVector links)
        ...
        """
        return _robotsim.RobotModelLink_getJacobian2(self, plocal, links)
    ...
    def getPositionJacobian2(self, plocal, links):
        r"""
        getPositionJacobian2(RobotModelLink self, double const [3] plocal, intVector links)
        ...
        """
        return _robotsim.RobotModelLink_getPositionJacobian2(self, plocal, links)
    ...
    def getOrientationJacobian2(self, links):
        r"""
        getOrientationJacobian2(RobotModelLink self, intVector links)
        ...
        """
        return _robotsim.RobotModelLink_getOrientationJacobian2(self, links)
...
class RobotModel(object):
    ...
    *current velocity* which are state-dependent. Several functions depend on the
    ...
    def getComJacobian2(self, links):
        r"""
        getComJacobian2(RobotModel self, intVector links)
        ...
        """
        return _robotsim.RobotModel_getComJacobian2(self, links)
...
class SimRobotSensor(object):
    ...
    def getMeasurementsBytes(self, buf):
        r"""
        getMeasurementsBytes(SimRobotSensor self, char * buf)
        ...
        """
        return _robotsim.SimRobotSensor_getMeasurementsBytes(self, buf)
