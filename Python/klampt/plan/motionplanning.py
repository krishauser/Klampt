...
class PlannerInterface(object):
    ...
    def __init__(self, *args):
        r"""
        __init__ (cspace): :obj:`PlannerInterface`

        __init__ (cspace,settings_json_string): :obj:`PlannerInterface`


        Args:
            cspace (:class:`~klampt.CSpaceInterface`): 
            settings_json_string (str, optional): 
        """
    ...
    def edgeCost(self, qa: object, qb: object) -> float:
        r"""
    ...
    def terminalCost(self, q: object) -> float:
        r"""
    ...
    def getEdgeCostFunction(self) -> object:
        r"""
    ...
    def getTerminalCostFunction(self) -> object:
        r"""
