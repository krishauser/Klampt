...
class Geometry3D(object):
    ...
    **Conversions**  
    ...
    def __init__(self, *args):
        ...
        Args:
            arg2 (:class:`~klampt.PointCloud` or :obj:`ConvexHull` or :class:`~klampt.VolumeGrid` or :class:`~klampt.Geometry3D` or :class:`~klampt.GeometricPrimitive` or :class:`~klampt.TriangleMesh`, optional): 
        """
