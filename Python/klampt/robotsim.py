...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_robotsim')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_robotsim')
...
class doubleArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _robotsim.doubleArray_frompointer
...
class floatArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _robotsim.floatArray_frompointer
...
class intArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _robotsim.intArray_frompointer
...
class Geometry3D(_object):
    ...
    *   ConvexHull  
    ...
    def __init__(self, *args):
        ...
        Args:
            arg2 (:obj:`ConvexHull` or :class:`~klampt.PointCloud` or :class:`~klampt.VolumeGrid` or :class:`~klampt.Geometry3D` or :class:`~klampt.TriangleMesh` or :class:`~klampt.GeometricPrimitive`, optional): 
        """
