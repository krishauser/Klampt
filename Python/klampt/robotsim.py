...
class Geometry3D(_object):
    ...
    *   convex hulls (ConvexHull)  
    ...
    def __init__(self, *args):
        ...
        Args:
            arg2 (:class:`~klampt.Geometry3D` or :obj:`ConvexHull` or :class:`~klampt.PointCloud` or :class:`~klampt.VolumeGrid` or :class:`~klampt.TriangleMesh` or :class:`~klampt.GeometricPrimitive`, optional): 
        """
