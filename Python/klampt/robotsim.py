...
class Geometry3D(_object):
    ...
    *   convex hulls (ConvexHull)  
    ...
    def __init__(self, *args):
        ...
        Args:
            arg2 (:class:`~klampt.PointCloud` or :class:`~klampt.Geometry3D` or :class:`~klampt.GeometricPrimitive` or :class:`~klampt.TriangleMesh` or :class:`~klampt.VolumeGrid` or :obj:`ConvexHull`, optional): 
        """
