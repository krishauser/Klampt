...
int parse_handshake(ws_ctx_t *ws_ctx, char *handshake) {
    ...
    */
    ...
    if (start) {
        ...
        if (!start)
        {
            handler_msg("couldn't find: Sec-WebSocket-Protocol in handshake\n");
            //return 0; 
    ...
    { 
       printf("sorry, only more modern HyBi/RFC 6455 is supported");
       return 0;
    }
      /*  else {
        // Hixie 75 or 76
